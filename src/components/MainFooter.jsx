          ...
          <div className="col-span-2 lg:col-span-1 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight">
                Farming<span className="text-emerald-500">Investor</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="h-8 w-8 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-emerald-500 hover:text-zinc-900 transition-all duration-300"
              >
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <Link
                  ...
                  className="text-zinc-300 hover:text-emerald-400 transition-colors flex items-center gap-2 group"
                >
