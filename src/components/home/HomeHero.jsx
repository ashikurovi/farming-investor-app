...
const slides = [
  {
    ...
    subtitle:
      "Join a community of forward-thinking investors. Access premium farmland and track real-time yields.",
    highlight: "Premium Agricultural Assets",
  },
  {
    image:
      "https://images.pexels.com/photos/4207906/pexels-photo-4207906.jpeg?auto=compress&cs=tinysrgb&w=1920",
    title: "Sustainable Smart Farming",
    subtitle:
      "Invest in high-tech greenhouses and automated irrigation systems for maximum efficiency and growth.",
    highlight: "Technology Driven",
  },
  {
    image:
      "https://images.pexels.com/photos/2132229/pexels-photo-2132229.jpeg?auto=compress&cs=tinysrgb&w=1920",
    title: "Global Food Security",
    subtitle:
      "Directly contribute to the global food supply chain while earning stable, long-term returns.",
...
export default function HomeHero() {
  return (
    <section className="w-full pt-0 md:pt-24 pb-12 px-0 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto h-[600px] rounded-none sm:rounded-3xl overflow-hidden shadow-2xl relative">
        <Swiper
          slidesPerView={1}
          spaceBetween={0}
          loop={true}
