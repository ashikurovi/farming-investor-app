  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4" role="list">
          <div className="rounded-2xl border border-emerald-100 bg-white/90 p-5 shadow-sm backdrop-blur dark:border-emerald-500/30 dark:bg-zinc-950" role="listitem">
