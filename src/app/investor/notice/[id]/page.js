    ...
    <div className="mx-auto max-w-4xl space-y-6 bg-background text-foreground">
      <div className="flex items-center gap-4">
        <Button
          ...
          onClick={() => router.back()}
          variant="outline"
          className="flex h-9 items-center gap-2 rounded-full px-4 text-xs font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-200 dark:hover:text-zinc-100"
        >
      ...
      <article className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="border-b border-zinc-100 bg-zinc-50/50 p-6 sm:p-8 dark:border-zinc-800 dark:bg-zinc-800/30">
          <div className="flex items-center gap-2 text-xs font-medium text-zinc-500 mb-4 dark:text-zinc-400">
