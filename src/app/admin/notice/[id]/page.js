      ...
      <div className="grid gap-6 sm:gap-8 lg:grid-cols-3 xl:gap-10">
        ...
        <aside className="space-y-6">
          <section className="relative overflow-hidden rounded-2xl sm:rounded-[2.5rem] border border-white/60 bg-white/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-3xl dark:border-zinc-800/40 dark:bg-zinc-900/40 dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] p-6 sm:p-8">
            <div className="absolute inset-0 z-0 bg-gradient-to-b from-primary/5 to-transparent opacity-50 dark:from-primary/10" />
            <div className="relative z-10">
              ...
              {notice.fileUrl ? (
                <div className="group/attachment relative overflow-hidden rounded-2xl border border-primary/20 bg-primary/5 p-1 transition-all hover:shadow-lg hover:shadow-primary/10 dark:border-primary/20 dark:bg-primary/10 dark:hover:shadow-primary/10">
                  <div className="relative flex flex-col gap-4 sm:gap-6 rounded-xl bg-white/50 p-4 sm:p-6 dark:bg-zinc-950/40 backdrop-blur-sm">
                    ...
                    <a
                      ...
                      className="group/btn flex w-full h-10 sm:h-11 items-center justify-center gap-2 rounded-lg sm:rounded-xl bg-[linear-gradient(135deg,var(--brand-from),var(--brand-to))] px-5 sm:px-6 text-xs sm:text-sm font-semibold text-white shadow-md shadow-primary/30 transition-all hover:brightness-110 active:scale-[0.98]"
                    >
