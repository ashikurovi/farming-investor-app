              ...
              <header className="border-b border-zinc-200/50 bg-white/50 p-6 sm:p-8 md:p-10 dark:border-zinc-800/50 dark:bg-zinc-950/40">
                <div className="flex flex-col gap-4 sm:gap-6">
                  <div className="flex items-center justify-between flex-wrap gap-3 sm:gap-4">
                    ...
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 text-[10px] sm:text-xs font-semibold tracking-wide shadow-sm backdrop-blur-md ring-1 ring-inset ${notice.isPublic
