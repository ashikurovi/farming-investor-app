      ...
      <div className="divide-y divide-zinc-100">
        {investments.length > 0 ? (
              ...
              <div className="flex items-center gap-4">
                {cleanUrl(inv.photoUrl) ? (
                  <div
                    ...
                    className="h-10 w-10 shrink-0 overflow-hidden rounded-lg bg-zinc-100 cursor-pointer ring-1 ring-zinc-200 hover:ring-emerald-300"
                  >
                    <Image
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-sm font-medium text-zinc-900">No investments found</p>
