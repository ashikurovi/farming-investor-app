...
export default function TopNavbar() {
  ...
  const displayName =
    ...
    "Admin User";
  const displayRole = user?.role ? String(user.role) : "Super Admin";
  ...
  return (
    <>
              ...
              <div className="absolute right-0 top-12 z-50 w-64 rounded-2xl border border-zinc-100 bg-white/95 p-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-2xl ring-1 ring-zinc-900/5 animate-in fade-in zoom-in-95 duration-200 dark:border-zinc-800 dark:bg-zinc-900/95 dark:ring-zinc-100/5">
                ...
                <div className="mt-1.5 border-t border-zinc-100 pt-1.5 dark:border-zinc-800">
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-xs font-medium text-red-600 hover:bg-red-50 transition-colors disabled:opacity-60 dark:text-red-400 dark:hover:bg-red-500/10"
                  >
      ...
      >
        ...
        <div
          className={`relative flex h-full w-64 flex-col border-r border-zinc-200 bg-white px-3 py-6 shadow-2xl transform transition-transform duration-300 ease-out dark:border-zinc-800 dark:bg-zinc-900 ${
              ...
              const renderLink = (linkItem, isNested = false) => {
                ...
                return (
                  <a
                    key={linkItem.name}
                    href={linkItem.href}
                    className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-zinc-600 transition-all hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 dark:active:bg-zinc-700 ${
                      isNested ? "text-xs" : ""
                    }`}
                    onClick={() => setMobileMenuOpen(false)}
                  >
