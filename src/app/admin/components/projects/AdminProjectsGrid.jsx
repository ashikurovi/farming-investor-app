                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mb-6 grid grid-cols-2 gap-3">
                    <div className="space-y-1 rounded-xl bg-zinc-50 p-3">
                      ...
                      <p className="text-sm font-bold text-zinc-900">{formatCurrency(investment)}</p>
                    </div>
                    <div className="space-y-1 rounded-xl bg-emerald-50/50 p-3">
                      ...
                      <div className="flex items-center gap-1">
                        <TrendingUp className={`h-3 w-3 ${isProfitPositive ? "text-emerald-600" : "text-rose-600"}`} />
                        <p className={`text-sm font-bold ${isProfitPositive ? "text-emerald-700" : "text-rose-700"}`}>
                          {formatCurrency(profit)}
                        </p>
                      </div>
                      <p className={`text-[10px] font-medium ${isProfitPositive ? "text-emerald-600" : "text-rose-600"}`}>
